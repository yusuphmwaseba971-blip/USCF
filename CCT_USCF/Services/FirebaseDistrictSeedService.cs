...
///     RegionId
///
/// RegionId matches FirebaseRegionSeedService.
///
/// IMPORTANT:
/// Run this once to populate Firestore.
/// </summary>
public class FirebaseDistrictSeedService
{
    private readonly IFirebaseFirestore _firestore;

    public FirebaseDistrictSeedService(
    ...
    {
        var districts =
            new List<(int Id, int RegionId, string Name)>
            {
                // =================================================
                // ARUSHA — RegionId 1
                // =================================================
        ...
        System.Diagnostics.Debug.WriteLine(
            "[FIREBASE DISTRICT SEED] SUCCESS: " +
